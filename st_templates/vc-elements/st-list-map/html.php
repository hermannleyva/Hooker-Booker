<?php
    $check_enable_map_google = st()->get_option('st_googlemap_enabled');
        ...
        echo st()->load_template( 'vc-elements/st-list-map/html-mapbox',false, $data_array);
        return;
    }
...
<div id="gmap_wrapper" class="st_list_map">
    ...
    <div class="gmap-controls">
        <div id="gmap-control">
            <span class="map-view"><i class="fa fa-picture-o"></i><?php _e("View",'traveler') ?></span>
            <div class="map_type">
                <span class="map-type-1 st-map-type" data-name="style_normal"><?php _e("Normal",'traveler') ?></span>
                <span class="map-type-2 st-map-type" data-name="style_midnight"><?php _e("Midnight",'traveler') ?></span>
                <span class="map-type-3 st-map-type" data-name="style_family_fest"><?php _e("Family Fest",'traveler') ?></span>
                <span class="map-type-4 st-map-type" data-name="style_open_dark"><?php _e("Open dark",'traveler') ?></span>
                <span class="map-type-5 st-map-type" data-name="style_riverside"><?php _e("Riverside",'traveler') ?></span>
                <span class="map-type-6 st-map-type" data-name="style_ozan"><?php _e("Ozan",'traveler') ?></span>
            </div>
            <span class="st_my_location_list_map" style="display: block;"><i class="fa fa-map-marker"></i><?php _e("My Location",'traveler') ?></span>
            <span class="st-gmap-full" data-full='<i class="fa fa-arrows-alt"></i><?php _e("Fullscreen",'traveler') ?>'
                  data-no-full='<i class="fa fa-square-o"></i><?php _e("Default",'traveler') ?>'>
                <i class="fa fa-arrows-alt"></i><?php _e("Fullscreen",'traveler') ?>
            </span>
        </div>
        <input type="text" id="google-default-search" name="google-default-search" placeholder="<?php _e( 'Google Maps Search' , 'traveler' );?>" value="" class="advanced_select  form-control">
        ...
        <div class="row">
            <div class="col-md-12 bg_white">
                <div class="pull-left div_fleid_search_map">
                    <?php echo st()->load_template( 'vc-elements/st-list-half-map/filter/' . esc_attr($st_type) , '' , $data_tmp ); ?>
                </div>
            </div>
        </div>
    </div>
...
<?php if ($show_data_list_map !="no"){?>
    <div class="div_data_list_map reset_map_">
        ...
        <div class="container">
            <h2 class='mb40'><?php printf(__("Advanced Search <span class='count_advan_saerch'>(%s)</span>",'traveler'),count($data_map)) ?>
            </h2>
