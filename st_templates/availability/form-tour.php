        ...
        <div class="calendar-form">
            ...
            <div class="row">
                ...
                <div class="col-xs-12">
                    ...
                    <p style="color: gray; background-color: #fffbd5; padding: 5px; border-radius: 15px; text-align: center; margin-bottom: 15px;">

                    Please indicate your availability.  For a quick and helpful video tutorial on how to add your availability, <a target="_blank" href="https://www.youtube.com/watch?v=cD1Tpq9_FNM">click here</a>
            ...
            <div class="row">
                ...
                <div class="col-xs-6 ">
                    ...
                    <div class="form-group">
                        ...
                        <label for="calendar_check_in"><?php echo __('Start', 'traveler'); ?></label>

                        <input value="<?php echo $currentDate; ?>" readonly="readonly" type="text" class="form-control date-picker" name="calendar_check_in" id="calendar_check_in">
                ...
                <div class="col-xs-6 ">
                    ...
                    <div class="form-group">
                        ...
                        <label for="calendar_check_out"><?php echo __('End', 'traveler'); ?></label>

                        <input value="<?php echo $currentDate; ?>"readonly="readonly" type="text" class="form-control date-picker" name="calendar_check_out" id="calendar_check_out">
...
<!--             <div class="row <?php echo ($post_type == 'st_tours') ? 'tour-calendar-price-person' : ''; ?>">
                ...
                <div class="col-xs-4 <?php if(get_post_meta($post_id,'hide_adult_in_booking_form',true) == 'on') echo 'hide' ?>">
                    ...
                    <div class="form-group">
                        ...
                        <label for="calendar_adult_price"><?php echo __('Adult Price', 'traveler'); ?></label>
                ...
                <div class="col-xs-4 <?php if(get_post_meta($post_id,'hide_children_in_booking_form',true) == 'on') echo 'hide' ?>">
                    ...
                    <div class="form-group ">
                        ...
                        <label for="calendar_child_price"><?php echo __('Child Price', 'traveler'); ?></label>
                ...
                <div class="col-xs-4 <?php if(get_post_meta($post_id,'hide_infant_in_booking_form',true) == 'on') echo 'hide' ?>">
                    ...
                    <div class="form-group ">
                        ...
                        <label for="calendar_infant_price"><?php echo __('Infant Price', 'traveler'); ?></label>
            ...
            <div class="row">
                ...
                <div style="display:none;" class="col-xs-6">
                    ...
                    <div class="form-group mt5" style="<?php if($type == 'specific_date'){echo 'display: none;';} ?>">
                        ...
                        <label for="calendar_groupday"><?php echo __('Group day', 'traveler'); ?></label>

                        <div class="ml20">

                            <input type="checkbox" name="calendar_groupday" id="calendar_groupday" class="i-check" value="1"><span class="ml5"><?php echo __('Group day', 'traveler'); ?></span>
            ...
            <div class="form-group">
                ...
                <input type="submit" id="calendar_submit" class="btn btn-primary" name="calendar_submit" value="<?php echo __('Update/Show Calendar', 'traveler'); ?>">
