...
<p class="booking-item-description">
    <?php echo __('Date:', 'traveler'); ?> <?php echo date_i18n($format . ' ' . get_option('time_format'), $pick_up_date); echo esc_html($pick_up_time);?> 
    <i class="fa fa-long-arrow-right"></i> <?php echo date_i18n($format . ' ' . get_option('time_format'), $drop_off_date) ; echo esc_html($drop_off_time);?>
    </br>
