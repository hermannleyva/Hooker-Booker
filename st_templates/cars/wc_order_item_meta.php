...
<ul class="wc-order-item-meta-list">
    ...
    <li>
        ...
        <span class="meta-data"><?php echo date_i18n(TravelHelper::getDateFormat().' '.get_option('time_format'),$item_data['_st_check_in_timestamp']); echo esc_html($pick_up_time) ?>
            <?php if(isset($item_data['_st_check_out_timestamp'])){?>
                <i class="fa fa-long-arrow-right"></i>
                <?php echo date_i18n(TravelHelper::getDateFormat().' '.get_option('time_format'),$item_data['_st_check_out_timestamp']); echo esc_html($drop_off_time) ?>
            <?php }?>
        </span>
    </li>
    <?php endif;?>
