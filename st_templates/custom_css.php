...
{
    $main_color.='#'.esc_html($_GET['main_color']);
}
...
.calendar-content.fc-unthemed .fc-basic-view .fc-head, .calendar-content.fc-theme-standard .fc-basic-view .fc-head, .calendar-starttime-content.fc-unthemed .fc-basic-view .fc-head, .calendar-starttime-content.fc-theme-standard .fc-basic-view .fc-head{ color:  <?php echo esc_attr($main_color)?> !important; }
