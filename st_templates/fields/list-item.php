    ...
    if(!empty($data['fields'])){
        ...
        foreach ($data['fields'] as $k => $v){
            ...
            <div class="item-inner <?php echo esc_attr($class_col); ?>">
                <?php echo st()->load_template('fields/' . esc_html($v['type']), '', array('data' => $v, 'list' => true)); ?>
            </div>
            <?php
        }
        echo '</div></div>';
        ...
        if(!empty($std_value)){
            ...
            echo '<div class="del"></div><div class="row">';
                foreach ($data['fields'] as $kk => $vv){
                    ...
                    if($name_temp == 'extra[extra_price_type]')
                        $name_temp = 'extra_price_type';
                    ...
                    if($name_temp == 'activity_program_title')
                        $name_temp = 'title';
                    if($name_temp == 'activity_program_desc')
                        $name_temp = 'desc';
                    if($name_temp == 'activity_program_image')
                        $name_temp = 'image';
                    ...
                    ?>
                    <div class="item-inner <?php echo esc_attr($class_col); ?>">
                        <?php echo st()->load_template('fields/' . esc_html($vv['type']), '', array('data' => $vv, 'list' => true, 'list_val' => isset($v[$name_temp]) ? $v[$name_temp] : '', 'post_id' => $post_id)); ?>
                    </div>
                    <?php
                }
                echo '</div></div>';
