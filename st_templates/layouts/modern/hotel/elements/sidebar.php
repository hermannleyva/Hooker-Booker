            ...
            <div class="search-form-wrapper sidebar-inner">
                ...
                <div class="search-form">
                    ...
                    <div class="search-title">
                        ...
                        <?php echo __('Search Hotels', 'traveler'); ?> <span class="hidden-lg hidden-md hidden-sm close-filter"><i class="fa fa-times" aria-hidden="true"></i></span>
    ...
    <?php
        ...
        if(!empty($filters)){
            ...
            foreach ($filters as $k => $v){
                ...
                echo st()->load_template('layouts/modern/hotel/elements/sidebar/' . esc_attr($v['rs_filter_type']), '', array('title' => $v['title'], 'taxonomy' => $v['rs_filter_type_taxonomy']));
