...
<div class="form-group form-group-lg form-group-icon-left st_right" data-next="2">
    ...
    <div class="st-select-wrapper tp-flight-wrapper" >
        <input required data-id="location_destination" type="text" data-locale="<?php echo esc_attr($locale_default); ?>" class="form-control tp-flight-location st-location-name" autocomplete="off" data-name="destination_iata" value="" placeholder="<?php echo esc_html__('Enter your destination', 'traveler'); ?>">
    </div>
</div>