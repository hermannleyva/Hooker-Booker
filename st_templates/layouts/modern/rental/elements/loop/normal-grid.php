...
<div class="item-service grid-item has-matchHeight">
    ...
    <div class="item-content">
        ...
        <div class="amenities clearfix">
            ...
            <span class="amenity size" data-toggle="tooltip" title="<?php echo esc_attr__('Square', 'traveler') ?>"><?php echo TravelHelper::getNewIcon('ico_square_1', '', '21px', '21px', false); ?><?php echo get_post_meta(get_the_ID(), 'rental_size', true); ?>m<sup>2</sup></span>
        </div>
    </div>
</div>
