        ...
        <div class="modal-content relative">
            ...
            <div class="modal-body">
                ...
                <form action="" class="form" method="post">
                    ...
                    <?php //OPTIMA - ACQUIRE PHONE NUMBER AT REGISTRATION ?>

                    <div class="form-group">

                        <input type="phone" class="form-control" name="st_phone" autocomplete="off"

                               placeholder="<?php echo esc_html__('Phone Number *', 'traveler') ?>">

                               <?php echo TravelHelper::getNewIcon('ico_phone_login_form', '', '18px', ''); ?>
