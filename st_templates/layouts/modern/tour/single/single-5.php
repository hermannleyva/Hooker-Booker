                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-8 col-md-9">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-6 col-lg-3">
                                    <div class="item">
                                        ...
                                        <div class="info">
                                            <h4 class="name"><?php echo esc_html__('Tour Type', 'traveler'); ?></h4>
                                            <p class="value">
                                                <?php
                                    ...
                                    if(!empty( $data )) {
                                        ...
                                        foreach( $data as $post ) :
                                            ...
                                            if(!empty( $map_lat ) and !empty( $map_lng ) and is_numeric( $map_lat ) and is_numeric( $map_lng )) {
                                                ...
                                                $data_map[$stt][ 'lat' ]              = (float) $map_lat;
                                                $data_map[$stt][ 'lng' ]              = (float) $map_lng;
                        ...
                        if (!empty($tour_faq)) {
                            ...
                            <div class="st-faq">
                                <h3 class="st-section-title">
                                    <?php echo esc_html__('FAQs', 'traveler'); ?>
                                </h3>
                                <?php $i = 0;
                                                ...
                                                <form id="form-booking-inpage" method="post" action="#booking-request"
                                                    ...
                                                    <div class="form-group form-more-extra st-form-starttime" <?php echo ($starttime_value != '') ? '' : 'style="display: none"' ?>>
                                                        <input type="hidden"
                                                               ...
                                                               data-posttype="st_tours"/>
                                                        <div class="" id="starttime_box">
                                                            <label><?php echo esc_html__('Start time', 'traveler'); ?></label>
                                                            <select class="form-control st_tour_starttime"
                                                                    name="starttime_tour"
                                                                    id="starttime_tour"></select>
                                                        </div>
