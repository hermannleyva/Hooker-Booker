                            ...
                            <div id="st-gallery-popup" class="hidden">
                                ...
                                if (!empty($gallery_array)) {
                                    ...
                                    foreach ($gallery_array as $k => $v) {
                                        ...
                                        echo '<a href="' . wp_get_attachment_image_url($v, 'full') . '">' . esc_html__('Image', 'traveler') . '</a>';
                    ...
                    <div class="col-xs-12 col-md-9">
                                ...
                                <div class="col-xs-6 col-lg-3">
                                    ...
                                    <div class="item">
                                        ...
                                        <div class="info">
                                            ...
                                            <h4 class="name"><?php echo esc_html__('Duration', 'traveler'); ?></h4>
                                ...
                                <div class="col-xs-6 col-lg-3">
                                    ...
                                    <div class="item">
                                        ...
                                        <div class="info">
                                            ...
                                            <h4 class="name"><?php echo esc_html__('Trip Type', 'traveler'); ?></h4>
                                            ...
                                            <p class="value">
                                                ...
                                                if ($tour_type == 'daily_tour') {
                                                    ...
                                                    echo esc_html__('Fishing Trip', 'traveler');
                                ...
                                <div class="col-xs-6 col-lg-3">
                                    ...
                                    <div class="item">
                                        ...
                                        <div class="info">
                                            ...
                                            <h4 class="name"><?php echo esc_html__('Group Size', 'traveler'); ?></h4>
                                ...
                                <div class="col-xs-6 col-lg-3">
                                    ...
                                    <div class="item">
                                        ...
                                        <div class="info">
                                            ...
                                            <h4 class="name"><?php echo esc_html__('Languages', 'traveler'); ?></h4>
                        ...
                        if (!empty($tours_highlight)) {
                            ...
                            <div class="st-highlight">
                                ...
                                <h3 class="st-section-title"><?php echo esc_html__('HIGHLIGHTS', 'traveler'); ?></h3>
                                ...
                                <div class="st-title-wrapper">
                                    ...
                                    <?php if ($tour_program_style == 'style1') { ?>
                                        ...
                                        <span class="expand" data-ex="1"
                                              ...
                                              data-text-more="<?php echo esc_html__('Expand All', 'traveler'); ?>"

                                              data-text-less="<?php echo esc_html__('Collapse All', 'traveler'); ?>"><?php echo esc_html__('Expand All', 'traveler'); ?></span>
                               ...
                               if(!empty($map_iframe)){ ?>
                                ...
                                <div class="st-map-wrapper">
                                    ...
                                    <div class="st-flex space-between">
                                        ...
                                        <h2 class="st-heading-section mg0"><?php echo __('Trip Location', 'traveler') ?></h2>
                            ...
                            <div id="reviews" data-toggle-section="st-reviews">
                                ...
                                <div class="review-pag-wrapper">
                                    ...
                                    <div class="review-pag-text">
                                        ...
                                        <?php echo sprintf(esc_html__('Showing %s - %s of %s in total', 'traveler'), $from, $to, get_comments_number_text('0', '1', '%')) ?>
                                                        ...
                                                        <div class="form-group form-date-field form-date-search clearfix <?php if ($has_icon) echo ' has-icon '; ?>"
                                                            ...
                                                            <div class="date-wrapper clearfix">
                                                                ...
                                                                <div class="check-in-wrapper">
                                                                    ...
                                                                    <span class="sts-tour-checkout-label <?php echo esc_html($class_hidden_enddate); ?>"><span> - </span><div
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-3">
                                ...
                                <div class="item has-matchHeight">
                                    ...
                                    <div class="featured">
                                        ...
                                        <?php echo st()->load_template('layouts/modern/hotel/loop/wishlist-2', '', ['style' => 'solid']); ?>
