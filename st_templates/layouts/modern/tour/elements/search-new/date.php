...
?>
<div class="form-group form-date-field form-date-search-new clearfix <?php echo esc_html($extraClass); ?> <?php if ($has_icon) echo ' has-icon '; ?>" data-format="<?php echo TravelHelper::getDateFormatMoment() ?>">
    <?php
    if ($has_icon) {
