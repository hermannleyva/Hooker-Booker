                                    ...
                                    <?php foreach ($hotel_package_custom as $key => $val): 
                                        ...
                                        <li>
                                            ...
                                            <div class="select-wrapper" style="width: 88px;">
                                                <div class="caculator-item">
                                                    <i class="fa fa-minus"></i>
                                                        <input class="form-control app extra-service-select" id="hotel-custom-<?php echo 'custom_qty_' . esc_attr($key); ?>" type="number" value="0" name="hotel_package[<?php echo 'custom_qty_' . esc_attr($key); ?>][]" step="1"  min="0">
                                                    <i class="fa fa-plus"></i>
                                                </div>
                                            </div>
                                    ...
                                    <?php foreach ($activity_package_custom as $key => $val): 
                                        ...
                                        <li>
                                            ...
                                            <div class="select-wrapper" style="width: 88px;">
                                                <div class="caculator-item">
                                                    <i class="fa fa-minus"></i>
                                                        <input class="form-control app extra-service-select" id="activity-custom-<?php echo 'custom_qty_' . esc_attr($key); ?>" type="number" value="0" name="activity_package[<?php echo 'custom_qty_' . esc_attr($key); ?>][]" step="1"  min="0">
                                                    <i class="fa fa-plus"></i>
                                                </div>
                                            </div>
                                    ...
                                    <?php foreach ($flight_package as $key => $val): ?>
                                        <li>
                                            ...
                                            <div class="select-wrapper" style="width: 88px;">
                                                <div class="caculator-item">
                                                    <i class="fa fa-minus"></i>
                                                        <input class="form-control app extra-service-select" id="flight-<?php echo 'qty_' . esc_attr($key); ?>" type="number" value="0" name="flight_package[<?php echo '_qty_' . esc_attr($key); ?>][]" step="1"  min="0">
                                                    <i class="fa fa-plus"></i>
                                                </div>
                                            </div>
                                        </li>
                                    ...
                                    <?php foreach ($flight_package_custom as $key => $val):
                                        ...
                                        <li>
                                            ...
                                            <div class="select-wrapper" style="width: 88px;">
                                                <div class="caculator-item">
                                                    <i class="fa fa-minus"></i>
                                                        <input class="form-control app extra-service-select" id="flight-custom-<?php echo 'custom_qty_' . esc_attr($key); ?>" type="number" value="0" name="flight_package[<?php echo 'custom_qty_' . esc_attr($key); ?>][]" step="1"  min="0">
                                                    <i class="fa fa-plus"></i>
                                                </div>
                                            </div>
                                        </li>
