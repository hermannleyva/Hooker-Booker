                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-8 col-md-9">
                                    ...
                                    <div class="st-program">
                                        ...
                                        <div class="st-program-list <?php echo esc_attr($tour_program_style); ?>">
                                            <?php
                                                ...
                                                if ( empty( $tour_program_style ) )
                                                    $tour_program_style = 'style1';
                                                echo st()->load_template( 'layouts/modern/activity/single/items/itenirary/' . esc_attr($tour_program_style) );
                                            ?>
                                        </div>
                                    </div>
                                <?php } ?>
                            ...
                            <div class="st-hr large st-height2"></div>
                                ...
                                <?php
                                $default = apply_filters('st_activity_property_near_by_params', array(
                                    'number'      => '12' ,
                                    'range'       => '50' ,
                                    'show_circle' => 'no' ,
                                ));
                                        ...
                                        <div class="col-lg-7">
                                            <div class="review-sumary">
                                                ...
                                                <div class="item">
                                                    ...
                                                    <div class="number"><?php echo esc_attr($rate_exe); ?></div>
                                                </div>
                                                ...
                                                <div class="item">
                                                    ...
                                                    <div class="number"><?php echo esc_attr($rate_good); ?></div>
                                                </div>
                                                ...
                                                <div class="item">
                                                    ...
                                                    <div class="number"><?php echo esc_attr($rate_poor); ?></div>
                                                </div>
                                            ...
                                            <div class="form-book-wrapper relative">
                                                ...
                                                <?php if(empty($activity_external) || $activity_external == 'off'){ ?>
                                                    <form id="form-booking-inpage" method="post" action="#booking-request" class="activity-booking-form">
                                                        ...
                                                        <div class="form-group form-more-extra st-form-starttime" <?php echo ($starttime_value != '') ? '' : 'style="display: none"' ?>>
                                                            <input type="hidden" data-starttime="<?php echo esc_attr($starttime_value); ?>"
                                                                   data-checkin="<?php echo esc_html($start); ?>" data-checkout="<?php echo esc_attr($end); ?>"
                                                                   data-tourid="<?php echo get_the_ID(); ?>" id="starttime_hidden_load_form"  data-posttype="st_activity"/>
                                                            <div class="" id="starttime_box">
                                                                <label><?php echo __('Start time', 'traveler'); ?></label>
                                                                <select class="form-control st_tour_starttime" name="starttime"
