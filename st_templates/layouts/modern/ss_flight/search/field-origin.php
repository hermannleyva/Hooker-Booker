...
<div class="form-group form-group-lg form-group-icon-left st_left">
    ...
    <div class="st-select-wrapper ss-flight-wrapper" >
        <input required id="ss_location_origin" type="text" class="form-control ss-flight-location required" autocomplete="off" data-value="" data-name="ss_origin" value="" placeholder="<?php echo esc_html__('Enter your origin', 'traveler'); ?>" data-index="1">
    </div>
</div>