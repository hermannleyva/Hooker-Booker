...
<?php if($booking_type == 'instant_enquire' || $booking_type == 'instant'){ ?>
            <form id="form-booking-inpage" class="classic form-has-guest-name" method="post" action="#booking-request">
                ...
                <?php if(STTour::_check_empty_package($hotel_package, $hotel_package_custom) || STTour::_check_empty_package($activity_package, $activity_package_custom) || STTour::_check_empty_package($car_package, $car_package_custom) || STTour::_check_empty_package($flight_package, $flight_package_custom)) { ?>
                    <h4><?php echo __('Tour Packages', 'traveler'); ?></h4>
                                                        ...
                                                        <?php foreach ($car_package_custom as $key => $val): ?>
                                                            <tr class="extra-collapse-control extra-none">
                                                                ...
                                                                <td width="20%">
                                                                    ...
                                                                    <select id="car-custom-<?php echo esc_html($key); ?>"
                                                                            style="width: 100px" class="form-control app"
        											        ...
        											        <?php foreach ($flight_package as $key => $val): ?>
                                                                <tr class="extra-collapse-control extra-none">
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <label class="ml20 mb10"><input type="radio" class="i-check flight_package" name="flight_package[<?php echo esc_html($flight_id); ?>][]" value="<?php echo htmlspecialchars(json_encode($flight_package_data_economy)); ?>"/><span class="mt2 d-i-b"><?php echo __('Economy', 'traveler'); ?> (<?php echo TravelHelper::format_money($val->flight_price_economy); ?>)</span></label>
                                                                        <?php $flight_package_data_business->flight_price_type = 'business'; ?>
                                                                        <label class="ml20"><input type="radio" class="i-check flight_package" name="flight_package[<?php echo esc_html($flight_id); ?>][]" value="<?php echo htmlspecialchars(json_encode($flight_package_data_business)); ?>"/><span class="mt2 d-i-b"><?php echo __('Business', 'traveler'); ?> (<?php echo TravelHelper::format_money($val->flight_price_business); ?>)</span></label>
                                                                    </td>
                                                                </tr>
        											        <?php endforeach; ?>
        										        <?php } } ?>
        											        ...
        											        <?php foreach ($flight_package_custom as $key => $val): ?>
                                                                <tr class="extra-collapse-control extra-none">
                                                                    <td width="100%" class="tour-package-hotel-check car-check">
        														        ...
        														        ?>
                                                                        <label for="activity-custom-<?php echo esc_attr($key); ?>"
                                                                               class="mt5"><?php echo esc_attr($val->flight_origin) . ' <i class="fa fa-long-arrow-right"></i> ' . balanceTags($val->flight_destination); ?>
                                                                        </label>
                                                                    </td>
                                                                    <td>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="package-info clearfix">
                                ...
                                <span class="head"><?php _e('Tour type', 'traveler') ?>: </span>
                                <span><?php if ($type_tour == 'daily_tour') echo __('Daily Tour', 'traveler'); else echo __('Specific Date', 'traveler') ?></span>
                            </div>
                            <?php if ($type_tour == 'daily_tour') { ?>
                                <div class="package-info clearfix">
                                    <i class="fa fa-calendar"></i>
                                    <span class="head"><?php _e('Duration', 'traveler') ?>: </span>
                                    <?php
                                        ...
                                        if ($tour_show_calendar == 'on'):
                                            ...
                                            <div class="row ">
                                                <div class="col-xs-12 col-sm-12">
                                                    <label for="check_in"><strong><?php _e('Departure date', 'traveler') ?>: </strong></label>

                                                    <input placeholder="<?php echo __("Select a day in the calendar", 'traveler'); ?>"
                                                           id="check_in" type="text" name="check_in"
                                                           value="<?php echo esc_attr($check_in); ?>" readonly="readonly"
                                                           class="form-control">
                                                </div>
                                                <div class="col-xs-12 col-sm-6 mt10">
                                                    <label for="check_out"><strong><?php _e('Return date', 'traveler') ?>: </strong></label>

                                                    <input id="check_out" type="text" name="check_out"
                                                           value="<?php echo esc_attr($check_out); ?>" readonly="readonly"
                                                           class="form-control">
                                                </div>
                                            </div>
                                        <?php else: ?>
                                            <div class="row">
                                                <div class="col-xs-12 mb5">
                                                    <a href="#list_tour_item" id="select-a-tour"
                                                       class="btn btn-primary"><?php echo __('Select a day', 'traveler'); ?></a>
                                                </div>
                                    ...
                                    <div class="row mt10">
                                        <?php if (get_post_meta(get_the_ID(), 'hide_adult_in_booking_form', true) != 'on'): ?>
                                            <div class="col-xs-12 col-sm-4">
                                                <label for="label_adult_number"><strong><?php _e('Adults', 'traveler') ?>: </strong></label>
                                        ...
                                        <?php if (get_post_meta(get_the_ID(), 'hide_children_in_booking_form', true) != 'on'): ?>
                                            <div class="col-xs-12 col-sm-4">
                                                <label for="label_child_number"><strong><?php _e('Children', 'traveler') ?>: </strong></label>
                                        ...
                                        <?php if (get_post_meta(get_the_ID(), 'hide_infant_in_booking_form', true) != 'on'): ?>
                                            <div class="col-xs-12 col-sm-4">
                                                <label for="label_infant_number"><strong><?php _e('Infant', 'traveler') ?>: </strong></label>
