    ...
    <div class="package-info-wrapper packge-info-wrapper-style2" style="width: 100%">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="tab-content py-3 px-3 px-sm-0" id="nav-tabContent">
                    <div class="tab-pane fade in active" id="nav-book" role="tabpanel" aria-labelledby="nav-book-tab">
                        ...
                        <form id="form-booking-inpage" method="post" action="" class="mt10 classic form-has-guest-name">
                            ...
                            <div class="div_book">
                                    ...
                                    if($tour_show_calendar == 'on'):
                                        ...
                                        <div class="row ">
                                            <div class="col-xs-12 ">
                                                ...
                                                <input placeholder ="<?php echo __("Select a day in the calendar", 'traveler') ; ?>" id="check_in" type="text" name="check_in" value="<?php echo esc_html($check_in); ?>" readonly="readonly" class="form-control mt10">
                                            </div>
                                            <div class="col-xs-12 mt10">
                                                <strong><?php _e('Return date','traveler')?>: </strong>

                                                <input id="check_out" type="text" name="check_out" value="<?php echo esc_html($check_out); ?>" readonly="readonly" class="form-control mt10">
                                            </div>
                                        </div>
                                    <?php else: ?>
                                        <div class="row mt10">
                                            ...
                                            <div class="col-xs-12 mb5" style="display: none">
                                                <strong><?php _e('Departure date','traveler')?>: </strong>
                                                <input placeholder ="<?php echo __("Select a day in the calendar", 'traveler') ; ?>" id="check_in" type="text" name="check_in" value="<?php echo esc_html($check_in); ?>" readonly="readonly" class="form-control">
                                            </div>
                                            <div class="col-xs-12 mb5" style="display: none">
                                                <strong><?php _e('Return date','traveler')?>: </strong>
                                                <input id="check_out" type="text" name="check_out" value="<?php echo esc_html($check_out); ?>" readonly="readonly" class="form-control">
                                            </div>
                                        </div>
                                        <div id="list_tour_item" data-type-tour="<?php echo esc_html($type_tour); ?>" style="display: none; width: 500px; height: auto;">
                                ...
                                <?php }else{ ?>
                                    <?php if(!empty($start_date_fixed) && !empty($end_date_fixed)){ ?>
                                        <input type="hidden" id="" name="check_in" value="<?php echo esc_html($convert_start_date_fixed); ?>" readonly="readonly" class="form-control">
                                        <input id="" type="hidden" name="check_out" value="<?php echo esc_html($convert_end_date_fixed); ?>" readonly="readonly" class="form-control">
                                    <?php } ?>
                                        ...
                                        <?php foreach($extra_price as $key => $val): ?>
                                            <tr>
                                                <td width="80%">
                                                    ...
                                                    <input type="hidden" name="extra_price[price][<?php echo esc_attr($val['extra_name']); ?>]" value="<?php echo esc_html($val['extra_price']); ?>">
                                                    <input type="hidden" name="extra_price[title][<?php echo esc_attr($val['extra_name']); ?>]" value="<?php echo esc_html($val['title']); ?>">
                                                </td>
                                                <td width="20%">
                                                    <select  style="width: 100px" class="form-control app" name="extra_price[value][<?php echo esc_attr($val['extra_name']); ?>]" id="field-<?php echo esc_attr($val['extra_name']); ?>">
                                                        ...
                                                        for($i = $start_i; $i <= $max_item; $i++):
                                                            ...
                                                            ?>
                                                            <option <?php echo esc_html($check) ?>  value="<?php echo esc_html($i); ?>"><?php echo esc_html($i); ?></option>
                                                        <?php endfor; ?>
                                                    </select>
                                                </td>
                                            </tr>
                                ...
                                if(STTour::_check_empty_package($hotel_package, $hotel_package_custom) || STTour::_check_empty_package($activity_package, $activity_package_custom) || STTour::_check_empty_package($car_package, $car_package_custom) || STTour::_check_empty_package($flight_package, $flight_package_custom)) { ?>
                                    <label><?php echo __('Tour Packages', 'traveler'); ?></label>
                                                                            ...
                                                                            <tr class="extra-collapse-control extra-none">
                                                                                <td width="" class="tour-package-hotel-check">
                                                                                    ...
                                                                                    <label for="field-<?php echo esc_attr($val->hotel_id); ?>"
                                                                                           class="ml20 mt5"><?php echo esc_html(get_the_title($val->hotel_id)) . ' (' . TravelHelper::format_money($val->hotel_price) . ')'; ?>
                                                                                        <?php
                                                                            ...
                                                                            <tr class="extra-collapse-control extra-none">
                                                                                <td width="100%" class="tour-package-hotel-check">
                                                                                    ...
                                                                                    <label for="hotel-custom-<?php echo esc_attr($key); ?>"
                                                                                           class="ml20 mt5"><?php echo esc_html($val->hotel_name) . ' (' . TravelHelper::format_money($val->hotel_price) . ')'; ?>
                                                                                        <?php
                                                                                        $star = $val->hotel_star;
                                                                                        echo '<ul class="icon-list icon-group booking-item-rating-stars">';
                                                                                        echo TravelHelper::rate_to_string($star);
                                                                            ...
                                                                            <tr class="extra-collapse-control extra-none">
                                                                                <td width="" class="tour-package-hotel-check car-check">
                                                                                    ...
                                                                                    <label for="field-<?php echo esc_attr($val->activity_id); ?>"
                                                                                           class="ml20 mt5"><?php echo esc_attr(get_the_title($val->activity_id)) . ' (' . TravelHelper::format_money($val->activity_price) . ')'; ?>
                                                                                    </label>
                                                                                </td>
                                                                            </tr>
                                                                        <?php endforeach; ?>
        											                        ...
        											                        <?php foreach ($flight_package as $key => $val): ?>
                                                                                <tr class="extra-collapse-control extra-none">
                                                                                    <td width="" class="tour-package-hotel-check car-check">
        														                        ...
        														                        ?>
                                                                                        <label for="activity-custom-<?php echo esc_attr($key); ?>"
                                                                                               class="mt5"><?php echo esc_html($origin_res) . ' <i class="fa fa-long-arrow-right"></i> ' . esc_html($destination_res); ?>
                                                                                        </label>
                                                                                    </td>
                                                                                    <td>
        											                        ...
        											                        <?php foreach ($flight_package_custom as $key => $val): ?>
                                                                                <tr class="extra-collapse-control extra-none">
                                                                                    <td width="100%" class="tour-package-hotel-check car-check">
        														                        ...
        														                        ?>
                                                                                        <label for="activity-custom-<?php echo esc_attr($key); ?>"
                                                                                               class="mt5"><?php echo esc_html($val->flight_origin) . ' <i class="fa fa-long-arrow-right"></i> ' . esc_html($val->flight_destination); ?>
                                                                                        </label>
                                                                                    </td>
                                                                                    <td>
                                ...
                                <div class="message_box mb10 mt10"></div>
            ...
            <div class="col-md-6 col-sm-12">
                <h3 class="rq-contact-title"><?php echo esc_html__('Contact with us', 'traveler'); ?></h3>
