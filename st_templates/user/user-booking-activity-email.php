...
<form class="form-inline booking-email-filter"
    ...
    <input type="hidden" name="sc" value="booking-activity"/>
...
<form class="booking-email-form" action="" method="post">
    ...
    <table class="table table-bordered table-striped table-booking-history table-booking-history-email">
        ...
        <?php if (!empty($posts)) {
                ...
                <tr>
                    ...
                    <td class="booking-history-type" style="text-align: left">
                        ...
                        if ($post_id) {
                            ...
                            echo '<a href="mailto:'. esc_attr(sanitize_email(get_post_meta($post_id, 'st_email', true))) .'">' . esc_html(sanitize_email(get_post_meta($post_id, 'st_email', true))) . '</a>';
            ...
            echo '<h5>' . __('No Activities', 'traveler') . '</h5>';
        }
        ?>
        </tbody>
    </table>
