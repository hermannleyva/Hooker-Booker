...
<div class="st-create">
    ...
    <h2><?php esc_html_e('Verifications','traveler') ?>

        <?php

        if(!$total_check) printf('<span class="verify-status none">%s</span>',esc_html__('Not verified','traveler'));

        else printf('<span class="verify-status">%s</span>',esc_html__('Verified','traveler'))
...
if(!empty($_COOKIE['st_success'])){
    ...
    printf('<div class="alert alert-success">%s</div>',wp_kses($_COOKIE['st_success'], array('p' => array())));
...
if(!empty($_COOKIE['st_errors'])){
    ...
    printf('<div class="alert alert-danger">%s</div>',wp_kses($_COOKIE['st_errors'], array('p' => array())));
...

{
    ...
    printf('<strong>%s</strong>',esc_html__('Admin Notification:','traveler'));
...
<form action="" class="st-js-validate" onsubmit="return false" method="post">
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    ...
                    <div class="form-group form-group-icon-left">
                        ...
                        <label class="st-form-group-title"><?php esc_html_e('E-mail','traveler') ?>
                ...
                <div class="col-sm-6">
                    ...
                    <div class="form-group form-group-icon-left">
                        ...
                        <label class="st-form-group-title"><?php esc_html_e('Phone Number','traveler') ?>
                ...
                <div class="col-sm-12 <?php if(!empty($keys_checks['passport'])) echo 'verified'; ?>">
                    ...
                    <label class="st-form-group-title"><?php esc_html_e('Personall identity card or passport','traveler') ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <label><?php esc_html_e('Name on card','traveler') ?></label>
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <label><?php esc_html_e('ID Card','traveler') ?></label>
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <label><?php esc_html_e('Birthday on Card','traveler') ?></label>
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <label><?php esc_html_e('Photos','traveler') ?></label>
                                    ...
                                    <?php if(empty($keys_checks['passport'])){  ?>
                                        ...
                                        <p><span class="btn btn-primary verify_photo_btn">
                                                ...
                                                <span class="on-loading"><?php esc_html_e('Uploading...','traveler') ?></span>

                                                <span class="non-loading"><?php esc_html_e('Select Images','traveler') ?></span>

                                                <input type="file" multiple class="verify_photo_inputs"></span></p>

                                        <p><i><?php esc_html_e('Maximum 5 images','traveler') ?></i></p>

                                        <p class="upload-notes"></p>

                                        <p class="note-on-error"><?php esc_html_e('Please select image','traveler') ?></p>
                ...
                <div class="col-sm-12 <?php if(!empty($keys_checks['passport'])) echo 'verified'; ?>">
                        ...
                        <label class="st-form-group-title"><?php esc_html_e('Travel Certificate','traveler') ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label><?php esc_html_e('Company name','traveler') ?></label>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label><?php esc_html_e('Email','traveler') ?></label>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label><?php esc_html_e('Company address','traveler') ?></label>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label><?php esc_html_e('Phone Number','traveler') ?></label>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <h3 class="representative-title"><?php esc_html_e('Representative','traveler') ?></h3>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label><?php esc_html_e('Fullname','traveler') ?></label>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label><?php esc_html_e('Position','traveler') ?></label>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label><?php esc_html_e('Personal Indentity/passport','traveler') ?></label>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label><?php esc_html_e('Issue date','traveler') ?></label>
                ...
                <div class="col-sm-12">
                    ...
                    <div class="form-group">
                        ...
                        <label class="st-form-group-title"><?php esc_html_e('Social','traveler') ?>
                        ...
                        <p class="connected <?php if(!get_user_meta($user->ID,'social_facebook_uid',true)) echo 'hidden'; ?>"><strong><?php esc_html_e('Facebook: Connected','traveler') ?> (<span><?php echo  get_user_meta($user->ID,'social_facebook_name',true)  ?></span>)</strong></p>
                        ...
                        <?php if(empty($keys_checks['social'])) { ?>
                            ...
                            <span class="btn btn-connect-facebook "><i class="fa fa-facebook"></i> <?php esc_html_e('Connect With Facebook','traveler') ?></span>
    ...
    <button type="submit" class="btn btn-primary btn-md mt30 "><?php esc_html_e('Submit','traveler') ?></button>
