...
<form class="form-inline booking-email-filter"
    ...
    <input type="hidden" name="sc" value="booking-tours"/>
...
<form class="booking-email-form" action="" method="post">
    ...
    <table class="table table-bordered table-striped table-booking-history table-booking-history-email">
        ...
        <tr>
            ...
            <th class="hidden-xs"><?php _e("Date", 'traveler') ?></th>
                ...
                <tr>
                    ...
                    if ($type_tour == 'daily_tour') {
                        ...
                        <td class="hidden-xs">
                            ...
                            if ($date) echo esc_html(date('d/m/Y', strtotime($date)) . ($value->starttime == '' ? '' : ' - ' . $value->starttime)); ?>
                            <br>
                        ...
                        <td class="hidden-xs">
                            ...
                            if ($date) echo date('d/m/Y', strtotime($date)); ?><br/>
                            <?php echo esc_html(($value->starttime == '' ? '' : __('Start time', 'traveler') . ': ' . $value->starttime)); ?>
                        </td>
                    <?php }
                    ?>
