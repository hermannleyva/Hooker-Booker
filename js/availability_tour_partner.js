            ...
            eventContent: function(arg) {
                ...
                if (arg.event.extendedProps.status) {
                    ...
                    if ( status === 'unavailable' ) {
                        ...
                        contentEl.innerHTML = '<div style="background-color: red;" class="not_available">'+st_params.text_unavailable+'</div>';

                    } else if (status === 'booked') {
                        
                        contentEl.classList.remove('available');

                        contentEl.classList.add('booked');

                        contentEl.innerHTML = '<div style="background-color: green;" class="booked">Booked</div>';
                        ...
                        if(price_type == 'person') {
                            ...
                            if (typeof arg.event.extendedProps.base_price != 'undefined') {
                                ...
                                basePriceEl.innerHTML = 'Available';
        ...
        $('.calendar-wrapper').each(function(index, el) {
            ...
            $('#calendar_submit', t).on('click', function(event) {
                ...
                data.push({
                    ...
                    value: 'st_opt_add_custom_price_tour'
