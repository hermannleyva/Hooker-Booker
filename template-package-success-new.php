            ...
            <div class="col-md-8">
                <div class="st-notice-success">
                    ...
                    <div class="title-admin">
                        <p class="st-admin-success"><?php $userdata = get_userdata( $get_order_by_token->partner );echo !empty($userdata->user_login) ? esc_html($userdata->user_login) : '' ; echo ', ';?> <span><?php echo __('your payment was successful!' , 'traveler' );?></span></p>
                        <p class="st-text">
