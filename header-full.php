        ...
        <div class="bg-holder full">
            ...
            <div class="bg-holder-content full text-white">
                ...
                <a class="logo-holder" href="<?php echo site_url()?>">
                    ...
                    <img src="<?php echo st()->get_option('logo','https://www.thehookerbooker.com/wp-content/uploads/2018/12/hooker_booker_logo_Raw.png') ?>" alt="logo" title="<?php bloginfo('name')?>">
