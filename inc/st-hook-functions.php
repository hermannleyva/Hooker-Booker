...
if (!function_exists('st_add_scripts')) {
    ...
    function st_add_scripts() {
        ...
        wp_register_script( 'fullcalendar', get_template_directory_uri() . '/js/fullcalendar-5.5.1/lib/main.min.js', [ 'jquery', 'moment.js' ], NULL, TRUE );
        wp_register_script( 'fullcalendar-lang', get_template_directory_uri() . '/js/fullcalendar-5.5.1/lib/locales-all.js', [ 'jquery' ], NULL, TRUE );
        wp_register_style('fullcalendar-css', get_template_directory_uri() . '/js/fullcalendar-5.5.1/lib/main.min.css');
...
//            wp_enqueue_script( 'custom.js', get_template_directory_uri() . '/js/custom.js', [ 'jquery' ], null, true );
        ...
        // template user
        wp_register_script('select2.js', get_template_directory_uri() . '/js/select2-new/js/select2.js', ['jquery'], NULL, TRUE);
        $lang = get_locale();
