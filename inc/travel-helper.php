<?php
    ...
    if ( !class_exists( 'TravelHelper' ) ) {
...

        {
            ...
            public function format_money_not_symbol($money = false, $need_convert = true, $precision = 0 ){
...

            {
                ...
                if ( count( $return ) ) {
                    ...
                    foreach ( $return as $key => $item ) {
                        ...
                        echo sprintf( __( 'Have %d new %s need check for approved.', 'traveler' ), count( $item ), $name );
...

            {
                ...
                if ( count( $data_user_register ) > 0 or count( $data_user_update_certificates ) > 0 ) {
                    ...
                    if ( count( $data_user_register ) > 0 ) {
                        ...
                        echo sprintf( __( 'ALERT:  We have %d captains waiting to be verified and approved!.', 'traveler' ), count( $data_user_register ) );
                    ...
                    foreach ( $terms as $key2 => $value2 ) {
                        ...
                        <div class="checkbox" style="margin-left: <?php echo ( 22 * $level ) . 'px'; ?>">
                            ...
                            <label>
                                ...
                                <input <?php if ( $checked ) echo "checked"; ?> value="<?php echo esc_attr($value2->term_id); ?>"
                ...
                if ( !empty( $terms ) ):
                    ...
                    foreach ( $terms as $key2 => $value2 ) {
                        ...
                        <div style="margin-left: <?php echo ( 22 * $level ) . 'px'; ?>"
                             ...
                             data-type="<?php echo esc_attr($taxonomy); ?>" data-value="<?php echo esc_attr($value2->term_id); ?>"><span
        ...
        */
...

            {
                ...
                <div class="layzyload-wrapper">
                    ...
                    <img class="st-lazy" data-src="<?php echo esc_attr($thumb_src); ?>" alt="<?php echo esc_attr($thumb_alt); ?>"
