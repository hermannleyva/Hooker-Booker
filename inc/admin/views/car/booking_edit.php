                        ...
                        <div class="postbox">
                            ...
                            <div class="inside">
                                ...
                                <div class="form-row">
                                    ...
                                    <label class="form-label" for=""><?php _e( 'Customer ID', 'traveler' ) ?></label>
                                    ...
                                    <div class="controls">
                                        ...
                                        <select class="" name="status">
                                            ...
                                            <option
                                                ...
                                                value="pending" <?php selected( $status, 'pending' ) ?> ><?php _e( 'Pending', 'traveler' ) ?></option>

                                            <option

                                                value="complete" <?php selected( $status, 'complete' ) ?> ><?php _e( 'Complete', 'traveler' ) ?></option>

                                            <option

                                                value="canceled" <?php selected( $status, 'canceled' ) ?> ><?php _e( 'Canceled', 'traveler' ) ?></option>
