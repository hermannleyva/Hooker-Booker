...
echo '<h2>'.__('User Partner','traveler').'</h2>';
...
<ul class="subsubsub">
    ...
    <li><a class="<?php if($st_tab=="partner") echo "current"; ?>" href="<?php echo admin_url("admin.php?page=st-users-list-partner-menu&st_tab=partner"); ?>"><?php _e("Partner",'traveler') ?> (<?php echo esc_html($total_partner['total']) ?>) </a> |</li>



    <li><a class="<?php if($st_tab=="partner_pending") echo "current"; ?>" href="<?php echo admin_url("admin.php?page=st-users-list-partner-menu&st_tab=partner_pending"); ?>"><?php _e("Partner Pending",'traveler') ?> (<?php echo esc_html($total_partner_pending['total']) ?>) </a> |</li>



    <li><a class="<?php if($st_tab=="partner_update") echo "current"; ?>" href="<?php echo admin_url("admin.php?page=st-users-list-partner-menu&st_tab=partner_update"); ?>"><?php _e("Partner Upgrade",'traveler') ?> (<?php echo esc_html($total_partner_update['total']) ?>)</a> |</li>



    <li class="partner-expire-date"><a class="<?php if($st_tab=="partner_expire") echo "current"; ?>" href="<?php echo admin_url("admin.php?page=st-users-list-partner-menu&st_tab=partner_expire"); ?>"><?php _e("Partner Expires",'traveler') ?></a></li>
...
<div class="tablenav top filter-admin-partner">
    ...
    <div class="alignleft actions bulkactions">
        ...
        <label for="bulk-action-selector-top" class="screen-reader-text"><?php _e('Select bulk action','traveler')?></label>
        ...
        <form id="posts-filter" action="<?php echo admin_url('admin.php?page=st-users-list-partner-menu')?>" method="get" style="display: inline-block">
            ...
            <input type="text" class="st_custommer_name" name="st_custommer_name" placeholder="<?php _e('Filter by customer name','traveler')  ?>" value="<?php echo STInput::get('st_custommer_name') ?>"/>
            ...
            <?php if($st_tab == 'partner_expire'){ ?>
                ...
                <input type="number" class="st_custommer_daydiff" name="st_custommer_daydiff" placeholder="<?php _e('Number of days','traveler')  ?>" value="<?php echo STInput::get('st_custommer_daydiff') ?>"/>
            ...
            <input type="submit" name="filter_action" id="post-query-submit" class="button" value="<?php _e('Search','traveler')?>">
        ...
        <table class="wp-list-table widefat fixed striped users">
            ...
            <tr>
                ...
                <td class="manage-column column-cb check-column" id="cb">
                    ...
                    <label for="cb-select-all-1" class="screen-reader-text"><?php _e("Select All",'traveler') ?></label>
                ...
                <th class="manage-column column-username column-primary  desc" id="username" scope="col">
                    ...
                    <span><?php _e("Username",'traveler') ?></span>
                ...
                <th class="manage-column column-name  desc" id="name" scope="col">
                    ...
                    <span><?php _e("Name",'traveler') ?></span>
                ...
                <th class="manage-column column-email  desc" id="email" scope="col">
                    ...
                    <span><?php _e("Email",'traveler') ?></span>
                ...
                <th class="manage-column column-email  desc" id="email" scope="col" style="width:10%;">



                    <span><?php _e("# of trips",'traveler') ?></span>
                ...
                <th class="manage-column" id="date" scope="col">
                    ...
                    <?php _e("Member package",'traveler') ?>
                ...
                <th class="manage-column" id="date" scope="col">
                    ...
                    <?php _e("Package Status",'traveler') ?>
                ...
                <th class="manage-column column-date" id="date" scope="col">
                    ...
                    <?php _e("Expiration date",'traveler') ?>
                    ...
                    <tr id="user-<?php  echo esc_attr($user_id) ?>">
                        ...
                        <td class="username column-username has-row-actions column-primary">
                            ...
                            <span class="edit">
                                ...
                                <a href="<?php echo admin_url("admin.php?page=st-users-list-partner-menu&st_action=approve_role&user_id=".$user_id."&st_tab=".$st_tab); ?>" class="button"><?php _e("Approved",'traveler') ?></a>



                                <a href="<?php echo admin_url("admin.php?page=st-users-list-partner-menu&st_action=cancel_role&user_id=".$user_id."&st_tab=".$st_tab); ?>" class="button"><?php _e("Cancel",'traveler') ?></a>
                        ...
                        <?php if($st_tab == 'partner'){ ?>
                            ...
                            <td colspan="2">
                                ...
                                <div class="verify-info">
                                    ...
                                    <button class="verify-view btn btn-primary" data-user_id ="<?php echo esc_attr($user_id); ?>" data-nonce="<?php echo wp_create_nonce( 'user_verifications' ); ?>">



                                        <?php echo __("View detail", 'traveler'); ?>
            ...
            <tr>
                ...
                <td class="manage-column column-cb check-column">
                    ...
                    <label for="cb-select-all-2" class="screen-reader-text"><?php _e("Select All",'traveler') ?></label>
                ...
                <th class="manage-column column-certificates" scope="col"><?php _e("Date Register",'traveler') ?></th>
...
<div id="user-verify-detail" class="user-verify-detail" data-id="outsite">
    ...
    <div class="st-text" data-text_verfied="<?php echo __('Verified', 'traveler'); ?>" data-text_apart="<?php echo __('A Part', 'traveler'); ?>" data-text_notverify="<?php echo __('Not Verified', 'traveler'); ?>" data-text_sendnotice="<?php echo __('Send notice', 'traveler'); ?>" data-text_noticerequired="<?php echo __('Notice is required.', 'traveler'); ?>"></div>
