...

    {
...

        {
            ...
            if ($user_id) {
                ...
                $subject = sprintf(__('New Captain! : %s', 'traveler'), $title);
...

        {
            ...
            $subject = sprintf(__('Your Captain registration at %s is pending approval!', 'traveler'), $title);
...

        {
            ...
            $subject = sprintf(__(' %s Captain Registration Has Been Received and Welcome to %s! ', 'traveler'), $title, $title);
...

        {
            ...
            $subject = sprintf(__('%s Captain Registration Has Been Cancelled! ', 'traveler'), $title);
