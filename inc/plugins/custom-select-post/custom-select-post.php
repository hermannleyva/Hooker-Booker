...
class STCustomselectpost
{
    ...
    function add_scripts()
    {
       if(!in_array(get_post_type( ) , array('product', 'shop_order'))){
         wp_enqueue_script('select2_js',$this->url.'/js/select2-new/js/select2.js',array('jquery'),null,true);
        $lang = get_locale();
        ...
        wp_register_style('select2_css',$this->url.'/js/select2-new/css/select2.css');
