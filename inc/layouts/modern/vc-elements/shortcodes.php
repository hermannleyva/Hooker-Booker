...
if (!function_exists('st_faq_solo')) {
    function st_faq_solo($attr, $content = false) {
        $attr = shortcode_atts([
            'title' => '',
            'list_faq' => array(),
                ], $attr);
        return st()->load_template('layouts/modern/elements/faq', 'solo', array('attr' => $attr));
    }
    st_reg_shortcode('st_faq_solo', 'st_faq_solo');
}
...
if (!function_exists('st_search_form_new_single_location')) {
    function st_search_form_new_single_location($attr, $content = false) {
        $attr = shortcode_atts([
            'form_type' => 'single',
            'service' => 'st_hotel',
            'style' => 'normal',
        ...
        return st()->load_template('layouts/modern/elements/search_form_single_location', '', $attr);
    }
    st_reg_shortcode('st_search_form_new_single_location', 'st_search_form_new_single_location');
}
...
if (!function_exists('st_list_of_hotel_service_loadmore')) {
    function st_list_of_hotel_service_loadmore($attr, $content = false) {
        $attr = shortcode_atts([
            'ids' => '',
            'posts_per_page' => 8,
                ], $attr);
        return st()->load_template('layouts/modern/elements/list_of_hotel_service_load_more', '', $attr);
    }
    st_reg_shortcode('st_list_of_hotel_service_loadmore', 'st_list_of_hotel_service_loadmore');
}
...
if (!function_exists('st_about_us_team_solo')) {
    function st_about_us_team_solo($attr, $content = false) {
        $attr = shortcode_atts([
            'title' => '',
            'list_team' => array(),
                ], $attr);
        return st()->load_template('layouts/modern/elements/aboutus', 'solo', array('attr' => $attr));
    }
    st_reg_shortcode('st_about_us_team_solo', 'st_about_us_team_solo');
}
...
if (!function_exists('st_room_taxonomy_ft')) {
    function st_room_taxonomy_ft($attr, $content = null) {
        return st()->load_template('layouts/modern/single_hotel/elements/room_taxonomy', '', array('attr' => $attr));
    }
    st_reg_shortcode('st_room_taxonomy', 'st_room_taxonomy_ft');
}
...
if (!function_exists('st_text_and_button_ft')) {
    function st_text_and_button_ft($attr, $content = null) {
        ...
        <?php if ($style_layout === 'style-2') { ?>
            <div class="content-text <?php echo esc_attr($style_layout); ?>">
        ...
        <?php } else { ?>
            <div class="content-text">
                <div class="st-text-center <?php echo esc_attr($style_layout); ?>">
                    <h2 class="text-center"><?php echo esc_attr($header_title); ?></h2>
...
if (!function_exists('st_slider_tour_ft')) {
    function st_slider_tour_ft($attr, $content = null) {
        return st()->load_template('layouts/modern/tour/elements/slider-home', '', array('attr' => $attr));
    }
    st_reg_shortcode('st_slider_tour', 'st_slider_tour_ft');
}
if (!function_exists('st_list_categories_ft')) {
    function st_list_categories_ft($attr, $content = false) {
        $attr = shortcode_atts([
            'category_ids' => '',
            'number' => 4,
            'style' => 'layout1'
                ], $attr);
        return st()->load_template('layouts/modern/elements/list_of_categories', '', $attr);
    }
    st_reg_shortcode('st_list_categories', 'st_list_categories_ft');
}

if (!function_exists('st_best_seller_ft')) {
    function st_best_seller_ft($attr, $content = null) {
        return st()->load_template('layouts/modern/tour/elements/best-seller', '', array('attr' => $attr));
    }
    st_reg_shortcode('st_best_seller', 'st_best_seller_ft');
}
if (!function_exists('st_introduce_ft')) {
    function st_introduce_ft($attr, $content = false) {
        $attr = shortcode_atts([
            'style' => 'style1',
            'image' => '',
            'logo' => '',
        ...
        return st()->load_template('layouts/modern/elements/introduce', '', $attr);
    }
    st_reg_shortcode('st_introduce', 'st_introduce_ft');
}
...
if (!function_exists('st_overview_new')) {
    function st_overview_new($attr, $content = false) {
        $attr = shortcode_atts([
            'title' => '',
            'content_over' => '',
            'link' => '',
                ], $attr);
        return st()->load_template('layouts/modern/elements/st_overview_new', '', array('attr' => $attr));
    }
    st_reg_shortcode('st_overview_new', 'st_overview_new');
}
if (!function_exists('st_tab_service_location')) {
    function st_tab_service_location($attr, $content = false) {
        $attr = shortcode_atts([
            'title_tab' => '',
            'service_tab' => '',
            'posts_per_page' => '',
                ], $attr);
        return st()->load_template('layouts/modern/location/elements/st_tab_service_location', '', array('attr' => $attr));
    }
    st_reg_shortcode('st_tab_service_location', 'st_tab_service_location');
}
if (!function_exists('st_list_post_ccv_ft')) {
    function st_list_post_ccv_ft($attr, $content = false) {
        $attr = shortcode_atts([
            'ids_post' => '',
                ], $attr);
        return st()->load_template('layouts/modern/location/elements/st_list_post', '', array('attr' => $attr));
    }
    st_reg_shortcode('st_list_post_ccv', 'st_list_post_ccv_ft');
}
...
if (!function_exists('st_banner_apartment')) {
    function st_banner_apartment_fnc($attr, $content = false) {
        $attr = shortcode_atts([
            "style" => "style1",
            "title" => "",
            "link_url" => "",
        ...
        return st()->load_template('layouts/modern/single_hotel/elements/banner', 'apartment', array('attr' => $attr));
    }
    st_reg_shortcode('st_banner_apartment', 'st_banner_apartment_fnc');
}
if (!function_exists('st_hotel_alone_mapbox_fnc')) {
    function st_hotel_alone_mapbox_fnc($attr, $content = false) {
        $attr = shortcode_atts([
            'list_location' => [],
            'map_zoom' => ''
                ], $attr);
        return st()->load_template('layouts/modern/single_hotel/elements/mapbox', '', array('attr' => $attr));
    }
    st_reg_shortcode('st_hotel_alone_mapbox', 'st_hotel_alone_mapbox_fnc');
}
if (!function_exists('st_offer_new_func')) {
    function st_offer_new_func($attr, $content = false) {
        return st()->load_template('layouts/modern/elements/offer_item_new', '', array('attr' => $attr, 'content' => $content));
    }
    st_reg_shortcode('st_offer_new', 'st_offer_new_func');
}

if (!function_exists('st_mailchimp_fnc')) {
    function st_mailchimp_fnc($attr, $content = false) {
        return st()->load_template('layouts/modern/elements/mailchimp', '', array('attr' => $attr, 'content' => $content));
    }

    st_reg_shortcode('st_mailchimp', 'st_mailchimp_fnc');
}
