                    ...
                    if ($val->status == 'available') {
                                        ...
                                        if (in_array($d, $list_date_2)) {
                                            ...
                                            if ($period < $booking_period) {
                                                ...
                                                $events['events'][] = [
                                                    ...
                                                    'end' => date('Y-m-d', $val->check_out),
                                                    'day' => date('d', $val->check_in),
                                                    'event' => TravelHelper::format_money(STPrice::getRentalPriceOnlyCustomPrice($rental_origin, $val->check_in, strtotime('+1 day', $val->check_in))),
                        ...
                        if (intval($val->check_out) - intval($val->check_in) == 0) {
                            $events['events'][] = [
                                ...
                                'end' => date('Y-m-d', intval($val->check_out)),
                                'day' => date('d', $i),
                                'event' => esc_attr__('Unavailable', 'traveler'),
                                'price' => esc_attr__('Unavailable', 'traveler'),
                                'status' => 'not_available',
