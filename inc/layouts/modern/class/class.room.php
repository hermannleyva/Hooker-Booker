        ...
        class STRoom extends TravelerObject
        {
            ...
            public function st_filter_hotel_room_ajax(){
                ...
                if($query->found_posts == 0){
                    echo '<h3 class="ajax-filter-not-found">'. __('No room found', 'traveler') .'</h3>';
                }
            ...
            {
                echo '<span class="booking-item-wishlist-title"><i class="fa fa-building-o"></i> ' . __( 'room', 'traveler' ) . ' <span></span></span>';
            }
            ...
            {
                return [ 'title' => __( 'Price Custom Settings', 'traveler' ), 'post_type' => 'hotel_room' ];
            }
