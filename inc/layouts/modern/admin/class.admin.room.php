...
//                $data['id']=$model->insert($data);
        ...
        function init_metabox()
        {
            ...
            $this->metabox[] = [
                ...
                'fields' => [
                    ...
                    [
                        'label' => __('Sub heading in banner', 'traveler'),
                        'id' => 'hotel_alone_room_sub_heading',
                        'type' => 'text',
                        'desc' => __('Enter sub heading display below title in banner', 'traveler'),
                    ...
                    [
                        ...
                        'choices' => [
                            [
                                ...
                                'src' => get_template_directory_uri() . '/v2/images/layouts/room_detail_1_preview.jpg',
                            ],
                            [
                                'value' => '2',
                                'label' => esc_html__('Layout 2', 'traveler'),
                                'src' => get_template_directory_uri() . '/v2/images/layouts/room_detail_2_preview.jpg',
                            ],
                        ],
                        'condition' => 'hotel_alone_room_layout:is(off)',
                    ], [
                        'label' => __('Hotel Room Layout', 'traveler'),
                        'id' => 'st_custom_layout_alone',
                        'post_type' => 'st_layouts',
                        'desc' => __('Select a layout to show single room', 'traveler'),
                        'type' => 'radio-image',
                        'section' => 'layout_tab',
                        ...
                        'choices' => [
                            [
                                'value' => '1',
                                'label' => esc_html__('Layout 1', 'traveler'),
                                'src' => get_template_directory_uri() . '/v2/images/layouts/room_detail_3_preview.jpg',
                            ],
                            [
                                'value' => '2',
                                'label' => esc_html__('Layout 2', 'traveler'),
                            ...
                            [
                                ...
                                'src' => get_template_directory_uri() . '/v2/images/layouts/room_detail_4_preview.png',
                            ],
                        ],
                        'condition' => 'hotel_alone_room_layout:is(on)',
                    ],
                    ...
                    [
                        ...
                        'settings' => [
                            [
                                ...
                                'type' => 'text',
                                'desc' => __('Enter No. days will be discounted', 'traveler')
                            ],
                            [
                                'id' => 'discount',
                    ...
                    [
                        'label' => __('Room Facility Preview', 'traveler'),
                        'id' => 'room_facility_preview',
                        'type' => 'upload',
                        'class' => '',
                        'desc' => __('Upload the hotel room detail facilities preview', 'traveler'),
                    ],
                    [
                    ...
                    [
                        'label' => __('Number of bathroom', 'traveler'),
                        'id' => 'bath_number',
                        'type' => 'text',
                        'desc' => __('Number of Bathroom', 'traveler'),
                        'std' => 0,
                        'condition' => 'hotel_alone_room_layout:is(on)',
                    ],
                    [
        ...
        static function _update_min_price($post_id = false)
        {
            ...
            if ($post_type == 'hotel_room') {
                $hotel_id = get_post_meta($post_id, 'room_parent', true);
                $new_hotel_id = STInput::post('room_parent');
