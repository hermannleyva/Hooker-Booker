                    ...
                    if($room_data['status']){
                        ...
                        if ( $query->have_posts() ) {
                            ...
                            $result = [
                                ...
                                'message'        => esc_html__( 'Our system does not find any rooms from your searching. You can change search feature now.', 'traveler' ),
            ...
            if($check_in != '' && $check_out != '') {
                ...
                if(!$is_minimum_stay){
                    ...
                    $result = [
                        ...
                        'message' => sprintf(__('Please book at least %d day(s) in total.', 'traveler'), $minimun_stay),
