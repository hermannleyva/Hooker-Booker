...
class ST_Social_Login
{
        ...
        if (class_exists("Abraham\TwitterOAuth\TwitterOAuth")) {
            ...
            try {
                ...
                if (!empty($access_token['oauth_token'])) {
                    ...
                    if (is_wp_error($handler)) echo balanceTags($handler->get_error_message());
                    else {
    ...
    {
        $user_email = STInput::post('useremail');
        ...
        if ($register_user) {
            ...
            $user_id = $this->createOauthAccount('google', $user_email, $oauth_uid, STInput::post('username'));
