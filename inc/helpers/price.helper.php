            ...
            if ( $price_by_per_person == 'on' ) {
                $html .= '
                    <tr>
                        ...
                        <th style="text-align: center" bgcolor="#CCC">'.__('Adult Price', 'traveler').'</th>
                        <th style="text-align: center" bgcolor="#CCC">'.__('Child Price', 'traveler').'</th>
                    </tr>
                ';
            } else {
                $html .= '
            ...
            if(get_post_type($room_id) == 'hotel_room'){
                ...
                foreach($groupday as $key => $date){
                    ...
                    if ( $price_by_per_person == 'on' ) {
                        $html .= '
                            <tr>
                                <td width="50%" style="border-bottom: 1px dashed #CCC">'.
                            date(TravelHelper::getDateFormat(), $date[0]).' <i class="fa fa-arrow-right "></i> '.date(TravelHelper::getDateFormat(), $date[1]).
                            '</td>
                                <td width="25%" style="border-bottom: 1px dashed #CCC; text-align: right">'.
                            TravelHelper::format_money($price_arr['adult_price'])
                            .'</td>
                            <td width="25%" style="border-bottom: 1px dashed #CCC; text-align: right">'.
                            TravelHelper::format_money($price_arr['child_price'])
                            .'</td>
                            </tr>
                        ';
                    } else {
