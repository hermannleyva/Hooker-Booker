            ...
            static function getDayFromNumber($number_of_day = 1){
                ...
                switch ($number_of_day){
                    ...
                    case 1:
                        ...
                        $day =  __('Monday', 'traveler');

                        break;

                    case 2:

                        $day =  __('Tuesday', 'traveler');

                        break;

                    case 3:

                        $day =  __('Wednesday', 'traveler');

                        break;

                    case 4:

                        $day =  __('Thursday', 'traveler');

                        break;

                    case 5:

                        $day =  __('Friday', 'traveler');

                        break;

                    case 6:

                        $day =  __('Saturday', 'traveler');

                        break;

                    case 7:

                        $day =  __('Sunday', 'traveler');
